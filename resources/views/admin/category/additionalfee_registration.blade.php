    ...
    <section class="card">
        <div class="card-body">
            ...
            <div class="row g-4">
                ...
                <div class="col-md-2">
                    <a class="btn btn-sm btn-primary" href="{{ url('admin/branch/list') }}" id="form-header-btn"><i
            ...
            @else
                <form method="POST" action="{{ route('additional_fee.update', $result[0]->id) }}"
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-md-5">
                            <div class="form-group">
                                <label for="name"><b>Name<span style="color:brown">*</span></b></label>
                                <div class="col-sm-10">
                                    <input type="text" name="name" value="{{ $result[0]->name }}" class="form-control"
                                        required>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-md-5">
                            <div class="form-group">
                                <label for="start_date"><b>Amount</b></label>
                                <div class="col-sm-10">
                                    <input type="text" name="amount" value="{{ $result[0]->additional_amount }}"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <select class="form-select" id="grade_id" name="grade_id">
                                        ...
                                        @foreach ($grade_list as $g)
                                            <option value="{{ $g->id }}"
                                                @if ($result[0]->grade_id == $g->id) selected @endif>{{ $g->name }}
                                            </option>
                                            @php  $gradeList[$g->id] = $g->name; @endphp
                                        @endforeach
                                    </select>
