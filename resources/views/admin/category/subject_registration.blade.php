    ...
    <section class="card">
        <div class="card-body">
            ...
            <div class="row g-4">
                ...
                <div class="col-md-2">
                    <a class="btn btn-sm btn-primary" href="{{ url('admin/subject/list') }}" id="form-header-btn"><i
            ...
            @if ($action == 'Add')
                <form method="POST" action="{{ route('subject.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-md-5">
                            <div class="form-group">
                                <label for="selectedOptions" class="form-label"><b>Grade</b></label>
                                <br>
                                <div class="btn-group" style="border: 1px solid #adb5bd;">
