    ...
    <section class="card">
        ...
        <div class="card-body">
            ...
            <div class="row g-4">
                ...
                <div class="col-md-2">
                    <a class="btn btn-sm btn-primary" href="{{ url('admin/teacher_info/list') }}" id="form-header-btn"><i
            ...
            <form method="POST" action="{{ route('teacher_info.store') }}" enctype="multipart/form-data">
                ...
                <div class="row g-4">
                    <div class="col-md-1"></div>
                    <fieldset class="form-group col-md-10 border p-3 m-3">
                        <legend for="reg_type" class="float-none w-auto" style='font-size:1.2em;'><b>Qualification</b>
                        </legend>
                        <div class="row">
                            <div class="form-group col-md-6">
                ...
                <div class="row g-4">
                    <div class="col-md-1"></div>
                    <fieldset class="form-group col-md-10 border p-3 m-3">
                        <legend for="reg_type" class="float-none w-auto" style='font-size:1.2em;'><b>Employment
                                History</b></legend>
                        <div class="row">
                            <div class="form-group col-md-6">
                ...
                <div class="row g-4">
                    <div class="col-md-1"></div>
                    <fieldset class="form-group col-md-10 border p-3 m-3">
                        <legend for="reg_type" class="float-none w-auto" style='font-size:1.2em;'><b>Education</b>
                        </legend>
                        <div class="row">
                            <div class="form-group col-md-6">
                ...
                <div class="row g-4">
                    ...
                    <div class="form-group col-md-10">
                        ...
                        <div class="image-preview-container">
                            ...
                            <input type="file" id="file-upload" name='teacher_profile' accept="image/*"
