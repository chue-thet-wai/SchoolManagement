...
<section class="card">
    <div class="card-body">
        ...
        <div class="row g-4">
            ...
            <div class="col-md-2">
                <a class="btn btn-sm btn-primary" href="{{url('admin/schedule/list')}}" id="form-header-btn"><i class="bi bi-skip-backward-fill"></i> Back</a>
            </div>
        </div>
                ...
                <div class="col-md-10">
                    <div class="row">
                        <div class="form-group col-md-6">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="start_time" value="{{$result[0]->start_time}}" class="form-control" required>
                            </div>
                        </div>
                        <div class="form-group col-md-6">
                            <label for=""><b>End Time</b></label>
                            <div class="col-sm-10">
                                <input type="text" name="end_time" value="{{$result[0]->end_time}}" class="form-control" required>
                            </div>
                        </div>
                    </div>
