    ...
    <section class="card">
        <div class="card-body">
            ...
            <div class="row g-4">
                ...
                <div class="col-md-2">
                    <a class="btn btn-sm btn-primary" href="{{ url('admin/payment/list') }}" id="form-header-btn"><i
                            ...
                            <div class="col-sm-10">
                                <div class='row ms-2'>
                                    <div class="form-check col-sm-4">
                                        <input class="form-check-input" type="radio" id="single" name="invoice_type"
                                            value="0" checked>
                                    ...
                                    <div class="form-check col-sm-4">
                                        <input class="form-check-input" type="radio" id="branch" name="invoice_type"
                                            value="1">
                        ...
                        <div class="card-body">
                            <div class="row g-4" id="single-invoice">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <div class='row'>
                                            <label for="student_id"><b>Student ID<span
                                                        style="color:brown">*</span></b></label>
                                            <div class="col-sm-10">
                                                <input type="text" id="student_id" name="student_id"
                                                    class="form-control">
                                            </div>
                                            <div class="col-md-2">
                                                <button type="button" name="registration_search" id="registration_search"
                                                    class="btn btn-sm btn-primary mt-1">Search</button>
                                            </div>
                                        </div>
                                        <div class="row">
                            ...
                            <div class="row g-4">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" id="grade_level_fee" name="grade_level_fee"
                            ...
                            <div class="row g-4">
                                ...
                                <div class="form-group">
                                        ...
                                        <input type="hidden" id="payment_type_choose" name="payment_type_choose" />
                                        <div class="col-sm-12">
                                            <div class="row">
                                                <div class="col-sm-4">
                                                ...
                                                <div class="col-sm-4">
                                                    <input type="radio" id="onetime" name="payment_type" value="2"><b> One Time</b>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="row g-4">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="pay_from_period"><b>Pay Period (From)</b><span
                                                style="color:brown">*</span></label>
                                        <div class="col-sm-10">
                                            <input type="date" id="pay_from_period" name="pay_from_period"
                                                class="form-control" required>
                                            <input type="hidden" id="academic_start" name="academic_start"
                                                value="{{ $academic_start }}" class="form-control" />
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="pay_to_period"><b>Pay Period (To)</b><span
                                                style="color:brown">*</span></label>
                                        <div class="col-sm-10">
                                            <input type="date" id="pay_to_period" name="pay_to_period"
                                                class="form-control" required>
                                            <input type="hidden" id="academic_end" name="academic_end"
                                                value="{{ $academic_end }}" class="form-control" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card col-md-10 mt-5 ms-3 p-3">
                                    ...
                                    <div class="card-body">
                                        @foreach ($additional_fee as $fee)
                                            <input type="checkbox" name="additionalFee[]" class="addfee_Checkbox"
                                                value="{{ $fee->id . '|' . $fee->additional_amount }}" /> <b>
                                                {{ $fee->name }} - {{ $fee->grade->name }}
                                                ({{ $fee->additional_amount }})
                                            </b>
                                            <br />
                                        @endforeach
                                    </div>
                            ...
                            <div class="row g-4">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="number" id="net_total" name="net_total" class="form-control"
                                                readonly>
                                        </div>
                                    </div>
                                </div>
