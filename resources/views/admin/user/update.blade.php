            ...
            <form method="POST" action="{{ route('user.update', $result[0]->user_id) }}" enctype="multipart/form-data">
                    ...
                    <div class="form-group col-md-5">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="name" class="form-control"
                                value="{{ old('name', $result[0]->name) }}" required>
                        </div>
                    </div>
                    <div class="form-group col-md-5">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="login_name" class="form-control"
                                value="{{ old('login_name', $result[0]->login_name) }}" required>
                        </div>
                    </div>
                    <div class="col-md-1"></div>
                </div>
                    ...
                    <div class="form-group col-md-5">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="email" class="form-control"
                                value="{{ old('email', $result[0]->email) }}" required>
                        </div>
                    </div>
                    <div class="form-group col-md-5">
                    ...
                    <div class="form-group col-md-5">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="contact_no" class="form-control"
                                value="{{ old('contact_no', $result[0]->contact_number) }}" required>
                        </div>
                    </div>
                    <div class="form-group col-md-5">
                        ...
                        <div class="col-sm-10">
                            <select class="form-select" id="department_id" name="department_id">
                                ...
                                @foreach ($department_list as $g)
                                    <option value="{{ $g['id'] }}" @if ($g['id'] == $result[0]->department_id) selected @endif>
                                        {{ $g['name'] }}</option>
                    ...
                    <div class="form-group col-md-5">
                        ...
                        <div class="col-sm-10">
                            <input type="date" name="startworking_date" class="form-control"
                                value="{{ date('Y-m-d', strtotime($result[0]->startworking_date)) }}" required>
                        </div>
                    </div>
                    <div class="col-md-1"></div>
                </div>
                ...
                <div class="row g-4">
                    ...
                    <div class="form-group col-md-10">
                        ...
                        <div class="col-sm-10">
                            <textarea name="address" class="form-control">{{ old('addrerss', $result[0]->address) }}</textarea>
                        </div>
                    </div>
                    <div class="col-md-1"></div>
                </div>
                ...
                <div class="row g-4">
                    ...
                    <div class="form-group col-md-10">
                        ...
                        <div class="col-sm-10">
                            <textarea name="remark" class="form-control">{{ old('remark', $result[0]->remark) }}</textarea>
                        </div>
                    </div>
                    <div class="col-md-1"></div>
                </div>
                    ...
                    <div class="form-group col-md-10">
                        ...
                        <div class="col-sm-10">
                            <input type="radio" id="inactive" name="status" value="0"
                                @if ($result[0]->resign_status != '1') checked @endif><b> Inactive</b>
                            <input type="radio" id="active" name="status" value="1"
                                @if ($result[0]->resign_status == '1') checked @endif><b> Active</b>
                        </div>
                    </div>
                    <div class="col-md-1"></div>
                </div>
