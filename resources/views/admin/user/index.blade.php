    ...
    <section class="card">
        <div class="card-body">
            ...
            <div class="row g-4">
                ...
                <div class="col-md-2">
                    <a class="btn btn-sm btn-primary" href="{{ route('user.create') }}" id="form-header-btn"><span
            ...
            <form class="row g-4" method="POST" action="{{ url('admin/user/list') }}" enctype="multipart/form-data">
                ...
                <div class='row g-4'>
                    <div class="form-group col-md-3">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="staffinfo_name" class="form-control"
                                value="{{ request()->input('staffinfo_name') }}">
                        </div>
                    </div>
                    <div class="form-group col-md-3">
                        <label for="staffinfo_email"><b>Email</b></label>
                        <div class="col-sm-10">
                            <input type="text" name="staffinfo_email" class="form-control"
                                value="{{ request()->input('staffinfo_email') }}">
                        </div>
                    </div>
                    <div class="form-group col-md-3">
                        <label for="staffinfo_contactno"><b>Contact Number</b></label>
                        <div class="col-sm-10">
                            <input type="text" name="staffinfo_contactno" class="form-control"
                                value="{{ request()->input('staffinfo_contactno') }}">
                        </div>
                    </div>
                </div>
                        ...
                        @if (!empty($list_result) && $list_result->count())
                            ...
                            @foreach ($list_result as $res)
                                <tr>
                                    ...
                                    <td>{{ \Carbon\Carbon::parse($res->startworking_date)->format('d-m-Y') }}</td>
                                    <td>
                                        @if ($res->resign_status == '1')
                                            Active
                                        @else
                                            Inactive
                                        @endif
                                    ...
                                    <td class="center">
                                        ...
                                        <form method="post" action="{{ route('user.destroy', $res->user_id) }}"
