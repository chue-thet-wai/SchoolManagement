    ...
    <div class="card-body">
        ...
        <div class="row g-4">
            ...
            <div class="col-md-9 card ms-3">
                ...
                <form method="POST" action="{{ url('admin/exam_terms_detail/update/'.$result[0]->id) }}" enctype="multipart/form-data">
                    @csrf
                    <br />
                    <input type="hidden" name="exam_terms_id" value="{{$exam_term_data['id']}}" />
                    <div class="row g-4">
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-md-10">
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="date" id="exam_date" name="exam_date" value="{{date('Y-m-d',strtotime($result[0]->exam_date))}}" class="form-control" required>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-1"></div>
                    ...
                    <div class="row g-4">
                        <div class="col-md-1"></div>
                        <div class="col-md-10">
                            <input type="hidden" id="previous_image" name="previous_image" value="{{$result[0]->subject_image}}">
                            <div class="form-group">
                                <label for="subject_image"><b>Upload Profile</b></label>
                                <div class="image-preview-container" style='width:65% !important;'>
                                    <div class="preview">
                                        <img id="preview-selected-image" src="{{asset('assets/subject_images/'.$result[0]->subject_image)}}" style='height:140px;display:block;'/>
                                    </div>
