...
<section class="card">
    <div class="card-body">
        ...
        <div class="row g-4">
            ...
            <div class="col-md-1">
                <a class="btn btn-sm btn-primary" href="{{url('admin/book_register/create')}}" id="form-header-btn"> Create</a>
            </div>
        </div>
        <br />
        <form class="row g-4" method="POST" href="{{ url('admin/book_register/list') }}" enctype="multipart/form-data">
			...
			<div class='row g-4'>
				<div class="form-group col-md-3">
					<label for="book_title"><b>Title</b></label>
					<div class="col-sm-10">
						<input type="text" name="book_title" class="form-control" value="{{ request()->input('book_title') }}">
					</div>
				</div>
			</div>			
			<div class='row p-3'>
