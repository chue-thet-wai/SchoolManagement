...
<section class="card">
    <div class="card-body">
        <div class="row g-4">
            ...
            <div class="col-md-2">
                <a class="btn btn-sm btn-primary" href="{{route('school_bus_track.create')}}" id="form-header-btn"><span class="bi bi-plus"></span> Create</a>
            </div>
        </div>
        <br />
                    ...
                    @if(!empty($list_result) && $list_result->count())
                        ...
                        <tr>
                            ...
                            <td class="center">
                                ...
                                <form method="post" action="{{ url('admin/school_bus_track_detail/list') }}" style="display: inline;">
                                    @csrf
                                    <input type="hidden" name="school_bus_track_id" value="{{$res->id}}" />
