...
<section class="card">
    <div class="card-body">
        ...
        <br />
        <form method="POST" action="{{route('school_bus_track.update',$result[0]->id)}}" enctype="multipart/form-data">
            @csrf
            <br />
            {{method_field('PUT')}}
            <div class="row g-4">
                ...
                <div class="col-md-5">
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="track_no" value="{{$result[0]->track_no}}" class="form-control" required readonly>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-5">
                    <div class="form-group">
                        <div class='row'>
                            ...
                            <div class="col-sm-10">
                                <input type="text" id="driver_id" name="driver_id" value="{{$result[0]->driver_id}}" class="form-control" required>
                            </div>
                            <div class="col-md-2">
            ...
            <div class="row g-4">
                ...
                <div class="col-md-5">
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="driver_name" value="{{$result[0]->driver_name}}"  id="driver_name" class="form-control" disabled>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row g-4">
                ...
                <div class="col-md-5">
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="driver_phone" id="driver_phone" value="{{$result[0]->driver_phone}}" class="form-control" disabled>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row g-4">
                ...
                <div class="col-md-5">
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="car_type" value="{{$result[0]->car_type}}" class="form-control" required>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row g-4">
                ...
                <div class="col-md-5">
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="car_no" value="{{$result[0]->car_no}}" class="form-control" required>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-10">
                    <div class='row'>
                        <div class="col-md-6">
                            ...
                            <div class="form-group">                       
                                <div class="col-sm-10">
                                    <input type="text" name="school_from_time" value="{{$result[0]->school_from_time}}" class="form-control" required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">                       
                                <div class="col-sm-10">
                                    <input type="text" name="school_to_time" value="{{$result[0]->school_to_time}}" class="form-control" required>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-10">
                    <div class='row'>
                        <div class="col-md-6">
                            ...
                            <div class="form-group">                       
                                <div class="col-sm-10">
                                    <input type="text" name="school_from_period" value="{{$result[0]->school_from_period}}" class="form-control" required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">                       
                                <div class="col-sm-10">
                                    <input type="text" name="school_to_period" value="{{$result[0]->school_to_period}}" class="form-control" required>
                                </div>
                            </div>
                        </div>
                    </div>
