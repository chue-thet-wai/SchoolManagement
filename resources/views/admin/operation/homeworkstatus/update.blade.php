    ...
    <div class="card-body">
        ...
        <div class="row g-4">
            ...
            <div class="col-md-9 content-title">
                <h4><b>Update Homework Status</b></h4>
            </div>
            <div class="col-md-2">
        ...
        <br />
        <form method="POST" action="{{route('homework_status.update',$result[0]->id)}}" enctype="multipart/form-data">
            @csrf
            <br />
            {{method_field('PUT')}}
            ...
            <div class="row g-4 mt-1">
                ...
                <div class="col-md-5">
                    <div class="form-group">
                        <div class='col-sm-4'>
                            <label for="homework_id"><b>Homework</b><span style="color:brown">*</span></label>
                        </div>
                        <div class='col-sm-8'>
                        ...
                        <div class='col-sm-8'>
                            <select class="form-select" id="student_id" name="student_id" required>
                                ...
                                <option  value="{{$student->student_id}}"
                                    @if ($result[0]->student_id == $student->student_id)
                                        selected
                                    @endif
                                    >{{$student->name}}</option>
                                @endforeach
