    ...
    <div class="card-body">
        ...
        <form method="POST" action="{{route('event.store')}}" enctype="multipart/form-data">
            ...
            <div class="row g-4">
                ...
                <div class="col-md-5">
                    <div class="form-group">
                        <label for=""><b>Academic Year</b><span style="color:brown">*</span></label>
                        <div class="col-sm-10">
                            <select class="form-select" id="academic_year_id" name="academic_year_id" required>
                                @foreach($academic as $a)
                                    <option value="{{$a->id}}" @if($loop->last) selected @endif>{{$a->name}}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
            ...
            <div class="row g-4">
                ...
                <div class="col-md-5">
                    <div class="form-group">
                        <label for="event_from_date"><b>From Date</b><span style="color:brown">*</span></label>
                        <div class="col-sm-10">
                            <input type="date" id="event_from_date" name="event_from_date" class="form-control" required>
                        </div>
                    </div>
                </div>
                <div class="col-md-5">
                    <div class="form-group">
                        <label for="event_to_date"><b>To Date</b><span style="color:brown">*</span></label>
                        <div class="col-sm-10">
                            <input type="date" id="event_to_date" name="event_to_date" class="form-control" required>
                        </div>
                    </div>
                </div>
            </div>
