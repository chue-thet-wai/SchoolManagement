...
<section class="card">
    <div class="card-body">
        <div class="row g-4">
            ...
            <div class="col-md-2">
                <a class="btn btn-sm btn-primary" href="{{route('news.create')}}" id="form-header-btn"><span class="bi bi-plus"></span> Create</a>
            </div>
        </div>
        <br />
        <form class="row g-4" method="POST" action="{{ url('admin/news/list') }}" enctype="multipart/form-data">
			@csrf
			<div class='row g-4'>
				<div class="form-group col-md-3">
					<label for="news_studentid"><b>Student ID</b></label>
					<div class="col-sm-10">
						<input type="text" name="news_studentid" class="form-control" value="{{ request()->input('news_studentid') }}">
					</div>
				</div>
			</div>			
			<div class='row p-3'>
                    ...
                    @if(!empty($list_result) && $list_result->count())
                        ...
                        <tr>
                            ...
                            <td class="center">
                                ...
                                <form method="post" action="{{route('news.destroy',$res->id)}}" style="display: inline;">
                                    @csrf
                                    {{ method_field('DELETE') }}
                                    <button type="submit" value="delete" class="btn m-1 p-0 border-0">
                                ...
                                <form method="get" action="{{ route('news_comment.list', ['id' => $res->id]) }}" style="display: inline;">
